...
classesRoutes.get("/", async (_req: Request, res: Response, next: NextFunction) => {
  try {
...
classesRoutes.post("/", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
classesRoutes.get("/:id", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
classesRoutes.put("/:id", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
classesRoutes.delete("/:id", async (req: Request, res: Response, next: NextFunction) => {
  try {
